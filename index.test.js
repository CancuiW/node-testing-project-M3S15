...
describe('[Exercise 1] trimProperties', () => {
  test('[1] returns an object with the properties trimmed', () => {
   ...
   test('[2] returns a copy, leaving the original object intact', () => {
     ...
     //after executing "utils.trimProperties(input)", the input will not change
...
describe('[Exercise 2] trimPropertiesMutation', () => {
  test('[3] returns an object with the properties trimmed', () => {
   ...
   test('[4] the object returned is the exact same one we passed in', () => {
     const input = { name: '  jane  ' }
     const actual = utils.trimPropertiesMutation(input)
     //.toBe()is to check if they are the same object
...
describe('[Exercise 7] isEvenNumberAsync', () => {
  ...
  test('[21] reject an error with the message "number must be a number" if passed foo', async () => {
   try{
  ...
  test('[22] reject an error with the message "number must be a number" if passed NaN', async () => {
    try {
